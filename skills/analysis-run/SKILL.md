...
6. **元数据文件必须保留**：至少维护 `.meta/analysis_plan.md`、`.meta/normalized_request.json`、`.meta/acquisition_log.jsonl`、`.meta/artifact_index.json`、`.meta/analysis_journal.md`、`.meta/user_request_timeline.md`。
