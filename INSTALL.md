...
如果你希望项目稳定在某个发布版，指定版本号即可。`0.3.21` 和 `v0.3.21` 都可以：

```bash
curl -fsSL https://raw.githubusercontent.com/dabaige53/RealAnalyst/main/scripts/install_codex_plugin.py | python3 - --version 0.3.21
```
